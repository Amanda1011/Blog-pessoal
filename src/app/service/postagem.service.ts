...
export class PostagemService {
  ...
  constructor(
    ...
    getAllPostagens(): Observable<Postagem[]>{
      return this.http.get<Postagem[]>('https://blogpessoalmands.herokuapp.com/postagens', this.token)
    }
    ...
    deletePostagem(id: number) {
      return this.http.delete(`https://blogpessoalmands.herokuapp.com/postagens/${id}`, this.token)
    }
}
